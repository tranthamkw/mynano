...
def connectdevice(sn,speed):
    ...
    if nanoport is None:
        ...
        sys.exit(0)
    tty = serial.Serial(nanoport, speed, bytesize=8, parity='N', stopbits=1, timeout=1)
#    tty = serial.Serial(nanoport, baudrate=baudRate[br], bytesize=8, parity='N', stopbits=1, timeout=1)
#    tty = serial.Serial(nanoport, baudrate=460800, bytesize=8, parity='N', stopbits=1, timeout=1)
    return tty
